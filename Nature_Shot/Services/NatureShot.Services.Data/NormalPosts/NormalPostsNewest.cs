namespace NatureShot.Services.Data.NormalPosts
{
    ...
    public class NormalPostsNewest : INormalPostsNewest
    {
        ...
        public NormalPostsNewest(IDeletableEntityRepository<Post> postRepository)
        {
            this.postRepository = postRepository;
        }

        public IEnumerable<NormalPostViewModel> GetNormalPostsNewest(int page, int count = GlobalConstants.Pages)
        {
