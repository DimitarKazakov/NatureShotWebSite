namespace NatureShot.Services.Data.NormalPosts
{
    ...
    public class NormalPostsMostLikes : INormalPostsMostLikes
    {
        ...
        public NormalPostsMostLikes(IDeletableEntityRepository<Post> postRepository, IRepository<PostReact> reactRepository)
        {
        ...
        public IEnumerable<NormalPostViewModel> GetNormalPostsMostLikes(int page, int count = GlobalConstants.Pages)
        {
