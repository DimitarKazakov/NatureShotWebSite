namespace NatureShot.Services.Data.NormalPosts
{
    ...
    public class NormalPostsLeastDislikes : INormalPostsLeastDislikes
    {
        private readonly IDeletableEntityRepository<Post> postRepository;
        private readonly IRepository<PostReact> reactRepository;

        public NormalPostsLeastDislikes(IDeletableEntityRepository<Post> postRepository, IRepository<PostReact> reactRepository)
        {
            this.postRepository = postRepository;
            this.reactRepository = reactRepository;
        }

        public IEnumerable<NormalPostViewModel> GetNormalPostsLeastDislikes(int page, int count = 4)
        {
