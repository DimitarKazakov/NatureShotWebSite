namespace NatureShot.Services.Data.PhotoPosts
{
    ...
    public class PhotoPostsLeastLikes : IPhotoPostsLeastLikes
    {
        ...
        public IEnumerable<ImagePostViewModel> GetImagePostsLeastLikes(int page, int count = 5)
        {
        ...
        public IEnumerable<ImagePostViewModel> SearchByCommentedPosts(int page, string input, int count = 5)
        {
        ...
        public IEnumerable<ImagePostViewModel> SearchByDislikedPosts(int page, string input, int count = 5)
        {
        ...
        public IEnumerable<ImagePostViewModel> SearchByLikedPosts(int page, string input, int count = 5)
        {
