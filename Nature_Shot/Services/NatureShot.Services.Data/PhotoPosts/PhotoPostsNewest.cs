namespace NatureShot.Services.Data.PhotoPosts
{
    ...
    public class PhotoPostsNewest : IPhotoPostsNewest
    {
        private readonly IDeletableEntityRepository<Post> postRepository;
        private readonly IRepository<PostReact> reactRepository;

        public PhotoPostsNewest(IDeletableEntityRepository<Post> postRepository, IRepository<PostReact> reactRepository)
        {
            this.postRepository = postRepository;
            this.reactRepository = reactRepository;
        }

        public PhotoPostsNewest(IDeletableEntityRepository<Post> postRepository)
        {
            this.postRepository = postRepository;
        }

        public IEnumerable<ImagePostViewModel> GetImagePostsNewest(int page, int count = GlobalConstants.Pages)
        {
