namespace NatureShot.Services.Data.VideoPosts
{
    ...
    public class VideoPostsOldest : IVideoPostsOldest
    {
        private readonly IDeletableEntityRepository<Post> postRepository;
        private readonly IRepository<PostReact> reactRepository;

        public VideoPostsOldest(IDeletableEntityRepository<Post> postRepository, IRepository<PostReact> reactRepository)
        {
            this.postRepository = postRepository;
            this.reactRepository = reactRepository;
        }

        public VideoPostsOldest(IDeletableEntityRepository<Post> postRepository)
        {
            this.postRepository = postRepository;
        }

        public IEnumerable<VideoPostViewModel> GetVideoPostsOldest(int page, int count = GlobalConstants.Pages)
        {
