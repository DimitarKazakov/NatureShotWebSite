namespace NatureShot.Services.Data.VideoPosts
{
    ...
    public class VideoPostsLeastDislikes : IVideoPostsLeastDislikes
    {
        ...
        public VideoPostsLeastDislikes(IDeletableEntityRepository<Post> postRepository)
        {
            this.postRepository = postRepository;
        }

        public IEnumerable<VideoPostViewModel> GetVideoPostsLeastDislikes(int page, int count = GlobalConstants.Pages)
        {
