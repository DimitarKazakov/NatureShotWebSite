namespace NatureShot.Services.Data.Tests.VideoPosts
{
    ...
    public class VideoPostsOldestsTests
    {
        public VideoPostsOldestsTests()
        {
        }

        [Fact]
        public void GetVideoPostsOldestShouldReturnFirstTwoElementsWhenThereAreTwoOrMore()
        {
            ...
            var service = new VideoPostsOldest(repository.Object);

            var posts = service.GetVideoPostsOldest(0, 2).ToList();
        ...
        [Fact]
        public void GetVideoPostsOldestShouldReturnSecondTwoElementsWhenThereAreFourOrMore()
        {
            var list = new List<Post>()
            {
                new Post
            ...
            var posts = service.GetVideoPostsOldest(1, 2).ToList();
        ...
        [Fact]
        public void GetVideoPostsOldestShouldReturnFirstElementWhenThereAreLessThanTwo()
        {
            var list = new List<Post>()
            {
                new Post
        ...
        [Fact]
        public void GetVideoPostsOldestShouldReturnThirdElementWhenThereAreThree()
        {
            var list = new List<Post>()
            {
                new Post
        ...
        [Fact]
        public void GetVideoPostsOldestShouldReturnZeroWhenEmpty()
        {
            var list = new List<Post>();
            var repository = new Mock<IDeletableEntityRepository<Post>>();
            repository.Setup(r => r.AllAsNoTracking()).Returns(() => list.AsQueryable());
