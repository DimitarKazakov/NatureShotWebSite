namespace NatureShot.Services.Data.Tests.VideoPosts
{
    ...
    public class VideoPostsShortestTests
    {
        public VideoPostsShortestTests()
        {
        }

        [Fact]
        public void GetVideoPostsShortestShouldReturnFirstTwoElementsWhenThereAreTwoOrMore()
        {
            ...
            var service = new VideoPostsShortest(repository.Object);

            var posts = service.GetVideoPostsShortest(0, 2).ToList();
        ...
        [Fact]
        public void GetVideoPostsShortestShouldReturnSecondTwoElementsWhenThereAreFourOrMore()
        {
            var list = new List<Post>()
            {
                new Post
            ...
            var posts = service.GetVideoPostsShortest(1, 2).ToList();
        ...
        [Fact]
        public void GetVideoPostsShortestShouldReturnFirstElementWhenThereAreLessThanTwo()
        {
            var list = new List<Post>()
            {
                new Post
        ...
        [Fact]
        public void GetVideoPostsShortestShouldReturnThirdElementWhenThereAreThree()
        {
            var list = new List<Post>()
            {
                new Post
        ...
        [Fact]
        public void GetVideoPostsShortestShouldReturnZeroWhenEmpty()
        {
            var list = new List<Post>();
            var repository = new Mock<IDeletableEntityRepository<Post>>();
            repository.Setup(r => r.AllAsNoTracking()).Returns(() => list.AsQueryable());
