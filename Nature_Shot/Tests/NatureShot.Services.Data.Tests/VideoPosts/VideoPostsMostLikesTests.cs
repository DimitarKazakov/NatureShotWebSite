namespace NatureShot.Services.Data.Tests.VideoPosts
{
    ...
    public class VideoPostsMostLikesTests
    {
        public VideoPostsMostLikesTests()
        {
        }

        [Fact]
        public void GetVideoPostsMostLikesShouldReturnFirstTwoElementsWhenThereAreTwoOrMore()
        {
            ...
            var service = new VideoPostsMostLikes(repository.Object);

            var posts = service.GetVideoPostsMostLikes(0, 2).ToList();
        ...
        [Fact]
        public void GetVideoPostsMostLikesShouldReturnSecondTwoElementsWhenThereAreFourOrMore()
        {
            var list = new List<Post>()
            {
                new Post
            ...
            var posts = service.GetVideoPostsMostLikes(1, 2).ToList();
        ...
        [Fact]
        public void GetVideoPostsMostLikesShouldReturnFirstElementWhenThereAreLessThanTwo()
        {
            var list = new List<Post>()
            {
                new Post
        ...
        [Fact]
        public void GetVideoPostsMostLikesShouldReturnThirdElementWhenThereAreThree()
        {
            var list = new List<Post>()
            {
                new Post
        ...
        [Fact]
        public void GetVideoPostsMostLikesShouldReturnZeroWhenEmpty()
        {
            var list = new List<Post>();
            var repository = new Mock<IDeletableEntityRepository<Post>>();
            repository.Setup(r => r.AllAsNoTracking()).Returns(() => list.AsQueryable());
