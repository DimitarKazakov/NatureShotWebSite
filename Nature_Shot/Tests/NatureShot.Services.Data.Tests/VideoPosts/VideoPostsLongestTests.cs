namespace NatureShot.Services.Data.Tests.VideoPosts
{
    ...
    public class VideoPostsLongestTests
    {
        public VideoPostsLongestTests()
        {
        }

        [Fact]
        public void GetVideoPostsLongestShouldReturnFirstTwoElementsWhenThereAreTwoOrMore()
        {
            ...
            var service = new VideoPostsLongest(repository.Object);

            var posts = service.GetVideoPostsLongest(0, 2).ToList();
        ...
        [Fact]
        public void GetVideoPostsLongestShouldReturnSecondTwoElementsWhenThereAreFourOrMore()
        {
            var list = new List<Post>()
            {
                new Post
            ...
            var posts = service.GetVideoPostsLongest(1, 2).ToList();
        ...
        [Fact]
        public void GetVideoPostsLongestShouldReturnFirstElementWhenThereAreLessThanTwo()
        {
            var list = new List<Post>()
            {
                new Post
        ...
        [Fact]
        public void GetVideoPostsLongestShouldReturnThirdElementWhenThereAreThree()
        {
            var list = new List<Post>()
            {
                new Post
        ...
        [Fact]
        public void GetVideoPostsLongestShouldReturnZeroWhenEmpty()
        {
            var list = new List<Post>();
            var repository = new Mock<IDeletableEntityRepository<Post>>();
            repository.Setup(r => r.AllAsNoTracking()).Returns(() => list.AsQueryable());
