namespace NatureShot.Services.Data.Tests.VideoPosts
{
    ...
    public class VideoPostsLeastLikesTests
    {
        public VideoPostsLeastLikesTests()
        {
        }

        [Fact]
        public void GetVideoPostsLeastLikesShouldReturnFirstTwoElementsWhenThereAreTwoOrMore()
        {
            ...
            var service = new VideoPostsLeastLikes(repository.Object);

            var posts = service.GetVideoPostsLeastLikes(0, 2).ToList();
        ...
        [Fact]
        public void GetVideoPostsLeastLikesShouldReturnSecondTwoElementsWhenThereAreFourOrMore()
        {
            var list = new List<Post>()
            {
                new Post
            ...
            var posts = service.GetVideoPostsLeastLikes(1, 2).ToList();
        ...
        [Fact]
        public void GetVideoPostsLeastLikesShouldReturnFirstElementWhenThereAreLessThanTwo()
        {
            var list = new List<Post>()
            {
                new Post
        ...
        [Fact]
        public void GetVideoPostsLeastLikesShouldReturnThirdElementWhenThereAreThree()
        {
            var list = new List<Post>()
            {
                new Post
        ...
        [Fact]
        public void GetVideoPostsLeastLikesShouldReturnZeroWhenEmpty()
        {
            var list = new List<Post>();
            var repository = new Mock<IDeletableEntityRepository<Post>>();
            repository.Setup(r => r.AllAsNoTracking()).Returns(() => list.AsQueryable());
