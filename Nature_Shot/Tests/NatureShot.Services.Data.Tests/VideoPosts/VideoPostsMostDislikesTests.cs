namespace NatureShot.Services.Data.Tests.VideoPosts
{
    ...
    public class VideoPostsMostDislikesTests
    {
        public VideoPostsMostDislikesTests()
        {
        }

        [Fact]
        public void GetVideoPostsMostDislikesShouldReturnFirstTwoElementsWhenThereAreTwoOrMore()
        {
            ...
            var service = new VideoPostsMostDislikes(repository.Object);

            var posts = service.GetVideoPostsMostDislikes(0, 2).ToList();
        ...
        [Fact]
        public void GetVideoPostsMostDislikesShouldReturnSecondTwoElementsWhenThereAreFourOrMore()
        {
            var list = new List<Post>()
            {
                new Post
            ...
            var posts = service.GetVideoPostsMostDislikes(1, 2).ToList();
        ...
        [Fact]
        public void GetVideoPostsMostDislikesShouldReturnFirstElementWhenThereAreLessThanTwo()
        {
            var list = new List<Post>()
            {
                new Post
        ...
        [Fact]
        public void GetVideoPostsMostDislikesShouldReturnThirdElementWhenThereAreThree()
        {
            var list = new List<Post>()
            {
                new Post
        ...
        [Fact]
        public void GetVideoPostsMostDislikesShouldReturnZeroWhenEmpty()
        {
            var list = new List<Post>();
            var repository = new Mock<IDeletableEntityRepository<Post>>();
            repository.Setup(r => r.AllAsNoTracking()).Returns(() => list.AsQueryable());
