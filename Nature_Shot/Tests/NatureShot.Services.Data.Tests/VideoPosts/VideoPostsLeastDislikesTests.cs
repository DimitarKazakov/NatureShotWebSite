namespace NatureShot.Services.Data.Tests.VideoPosts
{
    ...
    public class VideoPostsLeastDislikesTests
    {
        public VideoPostsLeastDislikesTests()
        {
        }

        [Fact]
        public void GetVideoPostsLeastDislikesShouldReturnFirstTwoElementsWhenThereAreTwoOrMore()
        {
            ...
            var service = new VideoPostsLeastDislikes(repository.Object);

            var posts = service.GetVideoPostsLeastDislikes(0, 2).ToList();

            Assert.Equal(2, posts.Count());
            Assert.Equal(list[3].Id, posts[0].VideoId);
            Assert.Equal(list[2].Id, posts[1].VideoId);
            repository.Verify(x => x.AllAsNoTracking(), Times.AtMost(2));
        }

        [Fact]
        public void GetVideoPostsLeastDislikesShouldReturnSecondTwoElementsWhenThereAreFourOrMore()
        {
            var list = new List<Post>()
            {
                new Post
            ...
            var posts = service.GetVideoPostsLeastDislikes(1, 2).ToList();
        ...
        [Fact]
        public void GetVideoPostsLeastDislikesShouldReturnFirstElementWhenThereAreLessThanTwo()
        {
            var list = new List<Post>()
            {
                new Post
        ...
        [Fact]
        public void GetVideoPostsLeastDislikesShouldReturnThirdElementWhenThereAreThree()
        {
            var list = new List<Post>()
            {
                new Post
        ...
        [Fact]
        public void GetVideoPostsLeastDislikesShouldReturnZeroWhenEmpty()
        {
            var list = new List<Post>();
            var repository = new Mock<IDeletableEntityRepository<Post>>();
            repository.Setup(r => r.AllAsNoTracking()).Returns(() => list.AsQueryable());
        ...
        public void SearchByTagsShouldReturnFirstTwoElementsWhenThereAreTwoOrMore()
        {
            ...
            Assert.Equal(2, posts.Count());
            Assert.Equal(list[0].Id, posts[0].VideoId);
            Assert.Equal(list[4].Id, posts[1].VideoId);
            repository.Verify(x => x.AllAsNoTracking(), Times.AtMost(2));
        }
