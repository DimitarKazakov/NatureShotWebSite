namespace NatureShot.Services.Data.Tests.NormalPostsTests
{
    ...
    public class NormalPostsLeastLikesTests
    {
        public NormalPostsLeastLikesTests()
        {
        }

        [Fact]
        public void GetNormalPostsLeastLikesShouldReturnFirstTwoElementsWhenThereAreTwoOrMore()
        {
            ...
            var service = new NormalPostsLeastLikes(repository.Object);

            var posts = service.GetNormalPostsLeastLikes(0, 2).ToList();
        ...
        [Fact]
        public void GetNormalPostsLeastLikesShouldReturnSecondTwoElementsWhenThereAreFourOrMore()
        {
            var list = new List<Post>()
            {
                new Post
            ...
            var posts = service.GetNormalPostsLeastLikes(1, 2).ToList();
        ...
        [Fact]
        public void GetNormalPostsLeastLikesShouldReturnFirstElementWhenThereAreLessThanTwo()
        {
            var list = new List<Post>()
            {
                new Post
        ...
        [Fact]
        public void GetNormalPostsLeastLikesShouldReturnThirdElementWhenThereAreThree()
        {
            var list = new List<Post>()
            {
                new Post
        ...
        [Fact]
        public void GetNormalPostsLeastLikesShouldReturnZeroWhenEmpty()
        {
            var list = new List<Post>();
            var repository = new Mock<IDeletableEntityRepository<Post>>();
            repository.Setup(r => r.AllAsNoTracking()).Returns(() => list.AsQueryable());
