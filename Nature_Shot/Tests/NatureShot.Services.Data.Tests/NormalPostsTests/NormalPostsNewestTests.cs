namespace NatureShot.Services.Data.Tests.NormalPostsTests
{
    ...
    public class NormalPostsNewestTests
    {
        public NormalPostsNewestTests()
        {
        }

        [Fact]
        public void GetNormalPostsNewestShouldReturnFirstTwoElementsWhenThereAreTwoOrMore()
        {
            ...
            var service = new NormalPostsNewest(repository.Object);

            var posts = service.GetNormalPostsNewest(0, 2).ToList();
        ...
        [Fact]
        public void GetNormalPostsNewestShouldReturnSecondTwoElementsWhenThereAreFourOrMore()
        {
            var list = new List<Post>()
            {
                new Post
            ...
            var posts = service.GetNormalPostsNewest(1, 2).ToList();
        ...
        [Fact]
        public void GetNormalPostsNewestShouldReturnFirstElementWhenThereAreLessThanTwo()
        {
            var list = new List<Post>()
            {
                new Post
        ...
        [Fact]
        public void GetNormalPostsNewestShouldReturnThirdElementWhenThereAreThree()
        {
            var list = new List<Post>()
            {
                new Post
        ...
        [Fact]
        public void GetNormalPostsNewestShouldReturnZeroWhenEmpty()
        {
            var list = new List<Post>();
            var repository = new Mock<IDeletableEntityRepository<Post>>();
            repository.Setup(r => r.AllAsNoTracking()).Returns(() => list.AsQueryable());
