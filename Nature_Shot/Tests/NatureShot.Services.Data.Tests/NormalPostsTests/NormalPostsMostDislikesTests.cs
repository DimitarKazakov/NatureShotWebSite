namespace NatureShot.Services.Data.Tests.NormalPostsTests
{
    ...
    public class NormalPostsMostDislikesTests
    {
        public NormalPostsMostDislikesTests()
        {
        }

        [Fact]
        public void GetNormalPostsMostDislikesShouldReturnFirstTwoElementsWhenThereAreTwoOrMore()
        {
            ...
            var service = new NormalPostsMostDislikes(repository.Object);

            var posts = service.GetNormalPostsMostDislikes(0, 2).ToList();
        ...
        [Fact]
        public void GetNormalPostsMostDislikesShouldReturnSecondTwoElementsWhenThereAreFourOrMore()
        {
            var list = new List<Post>()
            {
                new Post
            ...
            var posts = service.GetNormalPostsMostDislikes(1, 2).ToList();
        ...
        [Fact]
        public void GetNormalPostsMostDislikesShouldReturnFirstElementWhenThereAreLessThanTwo()
        {
            var list = new List<Post>()
            {
                new Post
        ...
        [Fact]
        public void GetNormalPostsMostDislikesShouldReturnThirdElementWhenThereAreThree()
        {
            var list = new List<Post>()
            {
                new Post
        ...
        [Fact]
        public void GetNormalPostsMostDislikesShouldReturnZeroWhenEmpty()
        {
            var list = new List<Post>();
            var repository = new Mock<IDeletableEntityRepository<Post>>();
            repository.Setup(r => r.AllAsNoTracking()).Returns(() => list.AsQueryable());
