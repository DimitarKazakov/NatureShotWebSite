namespace NatureShot.Services.Data.Tests.NormalPostsTests
{
    ...
    public class NormalPostsLeastDislikesTests
    {
        public NormalPostsLeastDislikesTests()
        {
        }

        [Fact]
        public void GetNormalPostsLeastDislikesShouldReturnFirstTwoElementsWhenThereAreTwoOrMore()
        {
            ...
            var service = new NormalPostsLeastDislikes(repository.Object);

            var posts = service.GetNormalPostsLeastDislikes(0, 2).ToList();

            Assert.Equal(2, posts.Count());
            Assert.Equal(list[3].Id, int.Parse(posts[0].PostId));
            Assert.Equal(list[2].Id, int.Parse(posts[1].PostId));
            repository.Verify(x => x.AllAsNoTracking(), Times.AtMost(2));
        }

        [Fact]
        public void GetNormalPostsLeastDislikesShouldReturnSecondTwoElementsWhenThereAreFourOrMore()
        {
            var list = new List<Post>()
            {
                new Post
            ...
            var posts = service.GetNormalPostsLeastDislikes(1, 2).ToList();

            Assert.Equal(2, posts.Count());
            Assert.Equal(list[1].Id, int.Parse(posts[0].PostId));
            Assert.Equal(list[0].Id, int.Parse(posts[1].PostId));
            repository.Verify(x => x.AllAsNoTracking(), Times.AtMost(2));
        }

        [Fact]
        public void GetNormalPostsLeastDislikesShouldReturnFirstElementWhenThereAreLessThanTwo()
        {
            var list = new List<Post>()
            {
                new Post
        ...
        [Fact]
        public void GetNormalPostsLeastDislikesShouldReturnThirdElementWhenThereAreThree()
        {
            var list = new List<Post>()
            {
                new Post
        ...
        [Fact]
        public void GetNormalPostsLeastDislikesShouldReturnZeroWhenEmpty()
        {
            var list = new List<Post>();
            var repository = new Mock<IDeletableEntityRepository<Post>>();
            repository.Setup(r => r.AllAsNoTracking()).Returns(() => list.AsQueryable());
