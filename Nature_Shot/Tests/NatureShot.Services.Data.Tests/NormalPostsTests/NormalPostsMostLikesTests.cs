namespace NatureShot.Services.Data.Tests.NormalPostsTests
{
    ...
    public class NormalPostsMostLikesTests
    {
        public NormalPostsMostLikesTests()
        {
        }

        [Fact]
        public void GetNormalPostsMostLikesShouldReturnFirstTwoElementsWhenThereAreTwoOrMore()
        {
            ...
            var service = new NormalPostsMostLikes(repository.Object);

            var posts = service.GetNormalPostsMostLikes(0, 2).ToList();
        ...
        [Fact]
        public void GetNormalPostsMostLikesShouldReturnSecondTwoElementsWhenThereAreFourOrMore()
        {
            var list = new List<Post>()
            {
                new Post
            ...
            var posts = service.GetNormalPostsMostLikes(1, 2).ToList();
        ...
        [Fact]
        public void GetNormalPostsMostLikesShouldReturnFirstElementWhenThereAreLessThanTwo()
        {
            var list = new List<Post>()
            {
                new Post
        ...
        [Fact]
        public void GetNormalPostsMostLikesShouldReturnThirdElementWhenThereAreThree()
        {
            var list = new List<Post>()
            {
                new Post
        ...
        [Fact]
        public void GetNormalPostsMostLikesShouldReturnZeroWhenEmpty()
        {
            var list = new List<Post>();
            var repository = new Mock<IDeletableEntityRepository<Post>>();
            repository.Setup(r => r.AllAsNoTracking()).Returns(() => list.AsQueryable());
