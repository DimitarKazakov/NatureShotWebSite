namespace NatureShot.Services.Data.Tests.PhotoPosts
{
    ...
    {
        public PhotoPostsLeastDislikesTests()
        {
        }

        [Fact]
        public void GetImagePostsLeastDislikesShouldReturnFirstTwoElementsWhenThereAreTwoOrMore()
        {
            ...
            var service = new PhotoPostsLeastDislikes(repository.Object);

            var posts = service.GetImagePostsLeastDislikes(0, 2).ToList();
        ...
        [Fact]
        public void GetImagePostsLeastDislikesShouldReturnSecondTwoElementsWhenThereAreFourOrMore()
        {
            var list = new List<Post>()
            {
                new Post
            ...
            var posts = service.GetImagePostsLeastDislikes(1, 2).ToList();
        ...
        [Fact]
        public void GetImagePostsLeastDislikesShouldReturnFirstElementWhenThereAreLessThanTwo()
        {
            var list = new List<Post>()
            {
                new Post
        ...
        [Fact]
        public void GetImagePostsLeastDislikesShouldReturnThirdElementWhenThereAreThree()
        {
            var list = new List<Post>()
            {
                new Post
        ...
        [Fact]
        public void GetImagePostsLeastDislikesShouldReturnZeroWhenEmpty()
        {
            var list = new List<Post>();
            var repository = new Mock<IDeletableEntityRepository<Post>>();
            repository.Setup(r => r.AllAsNoTracking()).Returns(() => list.AsQueryable());
