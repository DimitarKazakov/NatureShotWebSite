namespace NatureShot.Services.Data.Tests.PhotoPosts
{
    ...
    public class PhotoPostsMostDislikesTests
    {
        public PhotoPostsMostDislikesTests()
        {
        }

        [Fact]
        public void GetImagePostsMostDislikesShouldReturnFirstTwoElementsWhenThereAreTwoOrMore()
        {
            ...
            var service = new PhotoPostsMostDislikes(repository.Object);

            var posts = service.GetImagePostsMostDislikes(0, 2).ToList();

            Assert.Equal(2, posts.Count());
            Assert.Equal(list[4].Id, posts[0].ImageId);
            Assert.Equal(list[0].Id, posts[1].ImageId);
            repository.Verify(x => x.AllAsNoTracking(), Times.AtMost(2));
        }

        [Fact]
        public void GetImagePostsMostDislikesShouldReturnSecondTwoElementsWhenThereAreFourOrMore()
        {
            var list = new List<Post>()
            {
                new Post
            ...
            var posts = service.GetImagePostsMostDislikes(1, 2).ToList();

            Assert.Equal(2, posts.Count());
            Assert.Equal(list[1].Id, posts[0].ImageId);
            Assert.Equal(list[2].Id, posts[1].ImageId);
            repository.Verify(x => x.AllAsNoTracking(), Times.AtMost(2));
        }

        [Fact]
        public void GetImagePostsMostDislikesShouldReturnFirstElementWhenThereAreLessThanTwo()
        {
            var list = new List<Post>()
            {
                new Post
        ...
        [Fact]
        public void GetImagePostsMostDislikesShouldReturnThirdElementWhenThereAreThree()
        {
            var list = new List<Post>()
            {
                new Post
        ...
        [Fact]
        public void GetImagePostsMostDislikesShouldReturnZeroWhenEmpty()
        {
            var list = new List<Post>();
            var repository = new Mock<IDeletableEntityRepository<Post>>();
            repository.Setup(r => r.AllAsNoTracking()).Returns(() => list.AsQueryable());
        ...
        public void SearchByCaptionShouldReturnThirElementWhenThereLessThanFour()
        {
            ...
            Assert.Single(posts);
            Assert.Equal(list[3].Id, posts[0].ImageId);
            repository.Verify(x => x.AllAsNoTracking(), Times.AtMost(2));
        }
