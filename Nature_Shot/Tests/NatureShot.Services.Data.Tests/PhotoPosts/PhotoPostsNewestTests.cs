namespace NatureShot.Services.Data.Tests.PhotoPosts
{
    ...
    public class PhotoPostsNewestTests
    {
        public PhotoPostsNewestTests()
        {
        }

        [Fact]
        public void GetImagePostsNewestShouldReturnFirstTwoElementsWhenThereAreTwoOrMore()
        {
            ...
            var service = new PhotoPostsNewest(repository.Object);

            var posts = service.GetImagePostsNewest(0, 2).ToList();
        ...
        [Fact]
        public void GetImagePostsNewestShouldReturnSecondTwoElementsWhenThereAreFourOrMore()
        {
            var list = new List<Post>()
            {
                new Post
            ...
            var posts = service.GetImagePostsNewest(1, 2).ToList();
        ...
        [Fact]
        public void GetImagePostsNewestShouldReturnFirstElementWhenThereAreLessThanTwo()
        {
            var list = new List<Post>()
            {
                new Post
        ...
        [Fact]
        public void GetImagePostsNewestShouldReturnThirdElementWhenThereAreThree()
        {
            var list = new List<Post>()
            {
                new Post
        ...
        [Fact]
        public void GetImagePostsNewestShouldReturnZeroWhenEmpty()
        {
            var list = new List<Post>();
            var repository = new Mock<IDeletableEntityRepository<Post>>();
            repository.Setup(r => r.AllAsNoTracking()).Returns(() => list.AsQueryable());
