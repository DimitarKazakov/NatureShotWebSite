namespace NatureShot.Services.Data.Tests.PhotoPosts
{
    ...
    public class PhotoPostsOldestTests
    {
        public PhotoPostsOldestTests()
        {
        }

        [Fact]
        public void GetImagePostsOldestShouldReturnFirstTwoElementsWhenThereAreTwoOrMore()
        {
            ...
            var service = new PhotoPostsOldest(repository.Object);

            var posts = service.GetImagePostsOldest(0, 2).ToList();
        ...
        [Fact]
        public void GetImagePostsOldestShouldReturnSecondTwoElementsWhenThereAreFourOrMore()
        {
            var list = new List<Post>()
            {
                new Post
            ...
            var posts = service.GetImagePostsOldest(1, 2).ToList();
        ...
        [Fact]
        public void GetImagePostsOldestShouldReturnFirstElementWhenThereAreLessThanTwo()
        {
            var list = new List<Post>()
            {
                new Post
        ...
        [Fact]
        public void GetImagePostsOldestShouldReturnThirdElementWhenThereAreThree()
        {
            var list = new List<Post>()
            {
                new Post
        ...
        [Fact]
        public void GetImagePostsOldestShouldReturnZeroWhenEmpty()
        {
            var list = new List<Post>();
            var repository = new Mock<IDeletableEntityRepository<Post>>();
            repository.Setup(r => r.AllAsNoTracking()).Returns(() => list.AsQueryable());
