namespace NatureShot.Services.Data.Tests.PhotoPosts
{
    ...
    public class PhotoPostsMostLikesTests
    {
        public PhotoPostsMostLikesTests()
        {
        }

        [Fact]
        public void GetImagePostsMostLikesShouldReturnFirstTwoElementsWhenThereAreTwoOrMore()
        {
            ...
            var service = new PhotoPostsMostLikes(repository.Object);

            var posts = service.GetImagePostsMostLikes(0, 2).ToList();
        ...
        [Fact]
        public void GetImagePostsMostLikesShouldReturnSecondTwoElementsWhenThereAreFourOrMore()
        {
            var list = new List<Post>()
            {
                new Post
            ...
            var posts = service.GetImagePostsMostLikes(1, 2).ToList();
        ...
        [Fact]
        public void GetImagePostsMostLikesShouldReturnFirstElementWhenThereAreLessThanTwo()
        {
            var list = new List<Post>()
            {
                new Post
        ...
        [Fact]
        public void GetImagePostsMostLikesShouldReturnThirdElementWhenThereAreThree()
        {
            var list = new List<Post>()
            {
                new Post
        ...
        [Fact]
        public void GetImagePostsMostLikesShouldReturnZeroWhenEmpty()
        {
            var list = new List<Post>();
            var repository = new Mock<IDeletableEntityRepository<Post>>();
            repository.Setup(r => r.AllAsNoTracking()).Returns(() => list.AsQueryable());
